...
namespace LKMT.GUI
{
    public partial class fNhomSP : UserControl
    {
        ...
        {
            InitializeComponent();
            NhomSanPhamBLL.Instance.showNhomSP(dgvNhomSP);
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
           if(txtID.TextLength>5)
           {
            ...
            {
                if (NhomSanPhamBLL.Instance.themNhomSp(txtID.Text, txtName.Text))
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                if (NhomSanPhamBLL.Instance.xoaNhomSP(txtID.Text))
                {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                if (NhomSanPhamBLL.Instance.suaNhomSP(txtID.Text, txtName.Text, DateTime.Parse(txtNgayTao.Text)))
                {
