...
namespace LKMT.GUI
{
    public partial class fNhapKho : UserControl
    {
        ...
        {
            InitializeComponent();
            NhapKhoBLL.Instance.showPhieuNhap(dgvPhieuNhap);
            ...
            NhapKhoBLL.Instance.showLinhKienToComboBox(cboMaLK);
            NhapKhoBLL.Instance.showLinhKienToComboBox(cboTenLK);
        ...
        private void btnNhapKho_Click(object sender, EventArgs e)
        {
            ...
            {
                if (NhapKhoBLL.Instance.themPhieuNhap(cboMaLK.Text, (int)nmrSoLuong.Value, decimal.Parse(txtGiaNhap.Text)))
                {
        ...
        {
            NhapKhoBLL.Instance.selectChangesFromCboMaLk(cboMaLK, cboTenLK);

        }

        private void cboTenLK_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            NhapKhoBLL.Instance.selectChangesFromCboTenLK(cboMaLK, cboTenLK);
