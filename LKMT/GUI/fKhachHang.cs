...
namespace LKMT.GUI
{
    public partial class fKhachHang : UserControl
    {
        ...
        {
            InitializeComponent();
            KhachHangBLL.Instance.showKhachHang(dgvKhachHang);
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
           if (txtTenKH.TextLength == 0)
            ...
            {
                if (KhachHangBLL.Instance.themKhachHang(txtTenKH.Text,txtEmail.Text,txtMatKhau.Text,txtDienThoai.Text,txtDiaChi.Text))
                {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                if (KhachHangBLL.Instance.suaKhachHang(int.Parse(txtMaKH.Text),txtTenKH.Text, txtEmail.Text, txtMatKhau.Text, txtDienThoai.Text, txtDiaChi.Text, DateTime.Parse(txtNgayTao.Text)))
                {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            if(KhachHangBLL.Instance.timKhachHangbySDT(dgvKhachHang,txtSearchBox.Text))        
                 MessageBox.Show("Đã tìm thấy khách hàng có số điện thoại " + txtSearchBox.Text, "Thông Báo", MessageBoxButtons.OK);
