...
namespace LKMT.GUI
{
    public partial class fThanhToan : UserControl
    {
        ...
        {
            InitializeComponent();
            ThanhToanBLL.Instance.showThanhToan(dgvPhuongThuc);
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
           if (txtName.TextLength == 0)
            ...
            {
                if (ThanhToanBLL.Instance.themThanhToan(txtName.Text))
                {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ThanhToanBLL.Instance.suaThanhToan(int.Parse(txtID.Text),txtName.Text))
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (selectedRowCount > 0)
            {
                if (ThanhToanBLL.Instance.xoaThanhToan(int.Parse(txtID.Text)))
                {
