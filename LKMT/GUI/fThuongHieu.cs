...
namespace LKMT.GUI
{
    public partial class fThuongHieu : UserControl
    {
        ...
        {
            InitializeComponent();
            ThuongHieuBLL.Instance.showListThuongHieu(dgvThuongHieu);
        ...
        private void dgvThuongHieu_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (selectedRowCount >= 1)
            {
                if (e.RowIndex != -1)
                {
                    ...
                    NhomSanPhamBLL.Instance.showTenNhomToCBO(row.Cells[2].Value.ToString(), cboNhomLK);
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ThuongHieuBLL.Instance.themThuongHieu(txtMaTH.Text,txtTenThuongHieu.Text, cboNhomLK))
                {
                    MessageBox.Show("Thêm thương hiệu thành công!!", "Thông Báo", MessageBoxButtons.OK);
                    ThuongHieuBLL.Instance.showListThuongHieu(dgvThuongHieu, cboNhomLK);
                }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ThuongHieuBLL.Instance.suaThuongHieu(int.Parse(txtMaTH.Text), txtTenThuongHieu.Text, cboNhomLK, DateTime.Parse(txtNgayTao.Text)))
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (selectedRowCount > 0)
            {
                if (ThuongHieuBLL.Instance.xoaThuongHieu(int.Parse(txtMaTH.Text)))
                {
