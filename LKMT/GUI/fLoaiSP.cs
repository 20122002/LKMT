...
namespace LKMT.GUI
{
    public partial class fLoaiSP : UserControl
    {
        ...
        {
            InitializeComponent();
            LoaiSanPhamBLL.Instance.showLoaiSP(dgvLoaiSP);
        ...
        {
             LoaiSanPhamBLL.Instance.showListLoaiSP(dgvLoaiSP, cboNhomLK);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                if (LoaiSanPhamBLL.Instance.suaLoaiSP(txtMaLoai.Text, cboNhomLK, txtTenLoai.Text, DateTime.Parse(txtNgayTao.Text)))
                {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (LoaiSanPhamBLL.Instance.themLoaiSP(cboNhomLK, txtTenLoai.Text))
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (selectedRowCount > 0)
            {
                if (LoaiSanPhamBLL.Instance.xoaLoaiSP(txtMaLoai.Text))
                {
